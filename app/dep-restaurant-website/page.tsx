...
const RestaurantPageContent = dynamic(() => import("./RestaurantPageContent"), {
  ssr: false,
});
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900">
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-r from-orange-500 to-red-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse"></div>
          <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse delay-1000"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-red-600 to-orange-700 rounded-full mix-blend-multiply filter blur-xl opacity-15 animate-pulse delay-500"></div>
        ...
        <div className="relative z-10 text-center px-4 max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto text-pretty leading-relaxed font-persian">
              وب‌سایت رستوران زیبا با سیستم سفارش آنلاین و رزرو
            </p>
      ...
      {!isLoading && <RestaurantPageContent />}
    </div>
  );
}